 ...
 * @returns {TableEntry[]}
 */
export function get_printer_colors(layout_name) {
 ...
 * @returns {string}
 */
export function load_layout_from_file(layout_name, layout_bytes, _default) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(layout_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {Texture}
 */
export function print_badge(socket) {
 ...
 */
export function set_printer_color(layout_name, table_index, color_index, hex_color) {
    const ptr0 = passStringToWasm0(layout_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('web_spf_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
